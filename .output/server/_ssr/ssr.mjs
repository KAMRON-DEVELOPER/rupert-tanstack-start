...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } =
    await import('../_tanstack-start-manifest_v-B6hufdTL.mjs')
...
var manifest = {
  '0654a4dc85021aa78dde4baf518b85fa2858b512dd92903674d94b738617f541': {
    functionName: 'deleteSkillFn_createServerFn_handler',
    importer: () => import('./skill.functions-B16n8daR.mjs')
  },
  '079782766e5434dec06fc303c3845a0ed4775d25205efeda74d25d4c0f130175': {
    functionName: 'unfollowUserFn_createServerFn_handler',
    importer: () => import('./follow.function-k2eiGAUD.mjs')
  },
  '08cb90fbf3c2d4a239c851de4666c7a062a9beaab03dd4062e2db940269617f4': {
    functionName: 'createCityFn_createServerFn_handler',
    importer: () => import('./city.functions-3mmX3e0N.mjs')
  },
  '0b7cf93159d3934851ad6ecc1fa172985c3ad015cc9b83992cc2c65b1f2d610b': {
    functionName: 'getCountriesFn_createServerFn_handler',
    importer: () => import('./locations.functions-uC03fO8c.mjs')
  },
  '0fefc7e97d9dcb259dfa69a7647a7b66b9621205db47e7fc8194cc79bf373f84': {
    functionName: 'createUserSkillFn_createServerFn_handler',
    importer: () => import('./user-skill.function-DhEKaTHl.mjs')
  },
  '10904fc877b0fe6ecb590eb639b6a9ab8cc1446d922857c61ef09cf58454f32a': {
    functionName: 'deleteCityFn_createServerFn_handler',
    importer: () => import('./city.functions-3mmX3e0N.mjs')
  },
  '1cfe67b18d4875567e1323a55b11579a633907de444cb0da49b88f5141a42b67': {
    functionName: 'getVacanciesFn_createServerFn_handler',
    importer: () => import('./vacancies.functions-C8Zm8LPt.mjs')
  },
  '2071446b06c9c645d5aec0d687e719e68b169cc44116df5a487d0e1e993799a1': {
    functionName: 'revokeSessionFn_createServerFn_handler',
    importer: () => import('./session.function-CKowMB1h.mjs')
  },
  '2118d1cb95ed145b3597816e3f10a3c40b0489a7a2c9fb9d71c4f52aa8c821a9': {
    functionName: 'updateProfileFn_createServerFn_handler',
    importer: () => import('./users.functions-BoPblng_.mjs')
  },
  '23608d1ce4dd9141ce459b8b9b2b4a2562f774a42239db2875534087b0854b46': {
    functionName: 'getVacancyFn_createServerFn_handler',
    importer: () => import('./vacancies.functions-C8Zm8LPt.mjs')
  },
  ...
  '2f80f3be7a7d00480e77d6e03bc5f3eb6299b5f37957fdf688ce8bbdea76be2c': {
    functionName: 'getChatMessagesFn_createServerFn_handler',
    importer: () => import('./chats.functions-BEo6-eaA.mjs')
  },
  '3f155b40fdaec00b5c4270b981dc970152a6f10bd2dd046f80cf5b231f3f90a2': {
    functionName: 'getResumeFn_createServerFn_handler',
    importer: () => import('./resume.function-Bbwow48L.mjs')
  },
  '4061c953889ee1a90607708364ef4b4ee157a7e7d58c04148355ffbc55aeaafc': {
    functionName: 'getSkillsFn_createServerFn_handler',
    importer: () => import('./skills.functions-CnHW5fD9.mjs')
  },
  '4b5bde810533f7c2b286513a124bb3638eeb8aa5f374653b0505278aaa7a4439': {
    functionName: 'deleteProfileFn_createServerFn_handler',
    importer: () => import('./users.functions-BoPblng_.mjs')
  },
  '4f167d949175e8d0767305f0bf25c7c99bb55dd33a68134272c1dc7ccc5c8530': {
    functionName: 'updateSkillFn_createServerFn_handler',
    importer: () => import('./skill.functions-B16n8daR.mjs')
  },
  '512a5b71f05f26ff24776603ff4b89552798aa29d6a5348cecd28a7e70eb3369': {
    functionName: 'getCompanyFn_createServerFn_handler',
    importer: () => import('./companies.functions-BhEQqAL8.mjs')
  },
  '521a65821a32ea541346305e8d11a0474871ba56d7f741d798493e47a016b555': {
    functionName: 'getFollowersFn_createServerFn_handler',
    importer: () => import('./follow.function-k2eiGAUD.mjs')
  },
  '55921c90d29d1772e7a23a31fbaec83a5e29891063dae0b9b609e58f93f92204': {
    functionName: 'getWorkExperiencesFn_createServerFn_handler',
    importer: () => import('./work-experience.function-FSKpq56c.mjs')
  },
  '56f211fd91e3e384d2ba36626987500c4f50acc47113e81ccaf73fd4fb35b0d5': {
    functionName: 'deleteResumeFn_createServerFn_handler',
    importer: () => import('./resume.function-Bbwow48L.mjs')
  },
  '5d1554e43fd6e986a4e0012d7e64d9b29239b76a5a82236a4fbb4860f97246fe': {
    functionName: 'getStatsFn_createServerFn_handler',
    importer: () => import('./stats.functions-BOOWZikf.mjs')
  },
  '6183ac05653f3949294e86763ae45ca91c2fa3272918cba589d0b21081e5824a': {
    functionName: 'getApplicationFn_createServerFn_handler',
    importer: () => import('./vacancies.functions-C8Zm8LPt.mjs')
  },
  '6621bb1fb7f76133520b7693829da11a9fd42752aaf97d30710cb719975aeaac': {
    functionName: 'getResumesFn_createServerFn_handler',
    importer: () => import('./resume.function-Bbwow48L.mjs')
  },
  '6a1194b6b9c66d807333c1f589ccebb10c1082deed76a73bcaecbc18bb3acc41': {
    functionName: 'getCitiesFn_createServerFn_handler',
    importer: () => import('./locations.functions-uC03fO8c.mjs')
  },
  '6bce4c6a19b7d2c5719505574862d32890dabd09da7090447326313a82989214': {
    functionName: 'revokeSessionsFn_createServerFn_handler',
    importer: () => import('./session.function-CKowMB1h.mjs')
  },
  '6c3041275883677eb5a3f71a33c969adce92b7bcf82a747f8b93d3d312034eab': {
    functionName: 'authProbeFn_createServerFn_handler',
    importer: () => import('./auth.functions-B49PBkxE.mjs')
  },
  '6faa1e1ec0f86cf84b01c9aa4e1b1482b3b1d798e9ccb9d7d79f99e3f40d9178': {
    functionName: 'updateCountryFn_createServerFn_handler',
    importer: () => import('./country.functions-CaArw5Oi.mjs')
  },
  ...
  dee5cd9c2ddb9be48695e08da942045843925b10c7383203acd9da59a8c9d501: {
    functionName: 'deleteWorkExperienceFn_createServerFn_handler',
    importer: () => import('./work-experience.function-FSKpq56c.mjs')
  },
  e6abaac6f1263e57c94f481ac9503cee5f9a6f0a2205d7c4296895cb28e5f084: {
    functionName: 'followUserFn_createServerFn_handler',
    importer: () => import('./follow.function-k2eiGAUD.mjs')
  },
  ...
  e9ad0ad555b1b2c1b00abd984a331de538bd632510f322193e3072f9f97bd5b6: {
    functionName: 'getUserSkillsFn_createServerFn_handler',
    importer: () => import('./user-skill.function-DhEKaTHl.mjs')
  },
  eace28894f3d66e4eea57364435934c4a50b3f1a1aaf7bd9671ea0a599cc3449: {
    functionName: 'updateResumeFn_createServerFn_handler',
    importer: () => import('./resume.function-Bbwow48L.mjs')
  },
  ef498db43b8606709655310fd7f028976d3948380e659e3be83dc2fd4d44ea02: {
    functionName: 'updateWorkExperienceFn_createServerFn_handler',
    importer: () => import('./work-experience.function-FSKpq56c.mjs')
  },
  fedec73ecf7685613c6267cf6ec76b4028b2b7493e1f26463075983e718d81a1: {
    functionName: 'updateUserSkillFn_createServerFn_handler',
    importer: () => import('./user-skill.function-DhEKaTHl.mjs')
  }
}
 ...
 * entry URL.
 */
function buildClientEntryScriptTag(
  clientEntry,
  scriptFormat = 'module',
  crossOrigin
) {
...
export {
  ...
  getResponseHeaders as i,
  createServerFn as n,
  ssr_exports as o,
  getRequestHeader as r,
