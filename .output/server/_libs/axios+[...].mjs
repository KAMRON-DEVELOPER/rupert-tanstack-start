...
import { n as require_src, t as require_src$1 } from './agent-base+debug+ms.mjs'
...
var INVALID_BYTE_STRING_HEADER_VALUE_CHARS = /* @__PURE__ */ new RegExp(
  '[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+',
  'g'
)
...
var sanitizeByteStringHeaderValue = (value) =>
...
var AxiosError$1 = class AxiosError$1 extends Error {
  ...
  toJSON() {
    ...
    const redactKeys =
      config && utils_default.hasOwnProp(config, 'redact')
        ? config.redact
        : void 0
    const serializedConfig =
      utils_default.isArray(redactKeys) && redactKeys.length > 0
...
var require_delayed_stream = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_combined_stream = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_es_object_atoms = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    /** @type {import('.')} */
...
var require_es_define_property = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    /** @type {import('.')} */
...
var require_Reflect_getPrototypeOf = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_Object_getPrototypeOf = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_implementation = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_call_bind_apply_helpers = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    var bind = require_function_bind()
...
var require_es_set_tostringtag = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    var $defineProperty = require_get_intrinsic()(
...
var FormData_default = /* @__PURE__ */ __toESM(
  /* @__PURE__ */ __commonJSMin((exports, module) => {
    ...
    FormData.prototype._generateBoundary = function () {
      this._boundary =
        '--------------------------' + crypto$1.randomBytes(12).toString('hex')
    }
  ...
  function buildPath(path, value, target, index) {
    ...
    if (isLast) {
      if (utils_default.hasOwnProp(target, name))
        target[name] = utils_default.isArray(target[name])
    ...
    if (
      !utils_default.hasOwnProp(target, name) ||
      !utils_default.isObject(target[name])
    )
      target[name] = []
    if (
...
var own = (obj, key) =>
  obj != null && utils_default.hasOwnProp(obj, key) ? obj[key] : void 0
/**
...
var require_parse_proxy_response = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var debug = __importDefault(require_src()).default(
...
var require_follow_redirects = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    ...
    function RedirectableRequest(options, responseCallback) {
      ...
      this._headerFilter = new RegExp(
        '^(?:' +
          sensitiveHeaders
            .concat(options.sensitiveHeaders)
            .map(escapeRegex)
            .join('|') +
          ')$',
        'i'
    ...
    function wrap(protocols) {
      ...
      Object.keys(protocols).forEach(function (scheme) {
        ...
        var wrappedProtocol = (exports$1[scheme] =
    ...
    function resolveUrl(relative, base) {
      ...
      return useNativeURL
        ...
        : parseUrl(url$1.resolve(base, relative))
    }
...
var import_follow_redirects = /* @__PURE__ */ __toESM(
...
var formDataToStream = (form, headersHandler, options) => {
  const {
    ...
    boundary = tag +
      '-' +
      platform_default.generateString(size, BOUNDARY_ALPHABET)
  } = options || {}
...
function shouldBypassProxy(location) {
  ...
  const port =
    ...
    DEFAULT_PORTS[parsed.protocol.split(':', 1)[0]] ||
    0
  ...
  return noProxy.split(/[\s,]+/).some((entry) => {
    ...
    return (
      hostname === entryHost || (isLoopback(hostname) && isLoopback(entryHost))
    )
  })
}
//#endregion
...
function getTunnelingAgent(agentOptions, userHttpsAgent) {
  ...
  const cache = userHttpsAgent
    ? tunnelingAgentCacheUser.get(userHttpsAgent) ||
      tunnelingAgentCacheUser
        .set(userHttpsAgent, /* @__PURE__ */ new Map())
        .get(userHttpsAgent)
    : tunnelingAgentCache
  let agent = cache.get(key)
  if (agent) return agent
  agent = new import_dist.default(
...
function setProxy(
  ...
  if (proxy) {
    ...
    const readProxyField = (key) =>
      isProxyURL || utils_default.hasOwnProp(proxy, key) ? proxy[key] : void 0
    const proxyUsername = readProxyField('username')
    const proxyPassword = readProxyField('password')
    let proxyAuth = utils_default.hasOwnProp(proxy, 'auth')
      ? proxy.auth
      : void 0
    if (proxyUsername)
    ...
    if (proxyAuth) {
      ...
      const authUsername =
        authIsObject && utils_default.hasOwnProp(proxyAuth, 'username')
          ? proxyAuth.username
          : void 0
      const authPassword =
        authIsObject && utils_default.hasOwnProp(proxyAuth, 'password')
          ? proxyAuth.password
          : void 0
    ...
    if (isHttps.test(options.protocol)) {
      ...
      if (proxyProtocol)
        options.protocol = proxyProtocol.includes(':')
          ? proxyProtocol
          : `${proxyProtocol}:`
    }
  }
...
var buildAddressEntry = (address, family) =>
  resolveFamily(
    utils_default.isObject(address)
      ? address
      : {
          address,
          family
...
var http_default =
  ...
  function httpAdapter(config) {
    return wrapAsync(
      async function dispatchHttpRequest(resolve$1, reject, onDone) {
        const own = (key) =>
          utils_default.hasOwnProp(config, key) ? config[key] : void 0
        let data = own('data')
        ...
        if (config.socketPath) {
          ...
          if (config.allowedSocketPaths != null) {
            ...
            if (
              !allowed.some(
                (entry) =>
                  typeof entry === 'string' && resolve(entry) === resolvedSocket
              )
            )
              return reject(
                new AxiosError$1(
        ...
        req = transport.request(options, function handleResponse(res) {
          ...
          const streams = [res]
          const responseLength = utils_default.toFiniteNumber(
          ...
          responseStream =
            streams.length > 1
              ? stream.pipeline(streams, utils_default.noop)
              : streams[0]
          const response = {
          ...
          if (responseType === 'stream') {
            ...
            responseStream.on('error', function handleStreamError(err) {
              if (rejected) return
              reject(
                AxiosError$1.from(err, null, config, lastRequest, response)
              )
            })
  ...
  utils_default.forEach(
    ...
    function computeConfigValue(prop) {
      ...
      const configValue = merge(
        utils_default.hasOwnProp(config1, prop) ? config1[prop] : void 0,
        utils_default.hasOwnProp(config2, prop) ? config2[prop] : void 0,
        prop
      )
...
var resolveConfig_default = (config) => {
  ...
  const own = (key) =>
    utils_default.hasOwnProp(newConfig, key) ? newConfig[key] : void 0
  const data = own('data')
    ...
    headers.set(
      ...
      'Basic ' +
        btoa(
          (auth.username || '') +
            ':' +
            (auth.password ? encodeUTF8(auth.password) : '')
        )
    )
  if (utils_default.isFormData(data)) {
    if (
  ...
  if (platform_default.hasStandardBrowserEnv) {
    ...
    if (
      withXSRFToken === true ||
      (withXSRFToken == null && isURLSameOrigin_default(newConfig.url))
    ) {
      const xsrfValue =
...
var factory = (env) => {
  const globalObject =
    utils_default.global !== void 0 && utils_default.global !== null
  ...
  return async (config) => {
    ...
    const hasMaxContentLength =
      utils_default.isNumber(maxContentLength) && maxContentLength > -1
    const hasMaxBodyLength =
      utils_default.isNumber(maxBodyLength) && maxBodyLength > -1
    ...
    try {
      ...
      if (
        ...
        composedSignal.reason instanceof AxiosError$1
      ) {
...
//#endregion
export { axios as n, isAxiosError as t }
