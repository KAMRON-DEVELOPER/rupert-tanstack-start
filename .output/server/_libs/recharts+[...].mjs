...
import {
  ...
  n as require_range,
  o as require_get,
  r as require_throttle,
  t as require_isPlainObject
} from './es-toolkit.mjs'
import {
  a as createSlice,
  c as combineReducers,
  i as createListenerMiddleware,
  l as createSelector,
  n as configureStore,
  o as prepareAutoBatched,
  r as createAction,
  s as current,
  t as autoBatchEnhancer
} from './@reduxjs/toolkit+[...].mjs'
import { t as castDraft } from './immer.mjs'
import {
  n as shallowEqual,
  t as Provider_default
} from './react-redux+[...].mjs'
...
function svgPropertiesNoEventsFromUnknown(input) {
  ...
  if (
    /* @__PURE__ */ (0, import_react.isValidElement)(input) &&
...
function _objectWithoutProperties$18(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$18(e, t)
...
var Surface = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
  var { children, width, height, viewBox, className, style, title, desc } =
      props,
  ...
  return /* @__PURE__ */ import_react.createElement(
    'svg',
    _extends$23({}, svgPropertiesAndEvents(others), {
...
function _objectWithoutProperties$17(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$17(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
...
var Layer = /* @__PURE__ */ import_react.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ import_react.createElement(
    'g',
    _extends$22({ className: layerClass }, svgPropertiesAndEvents(others), {
      ref
    }),
    children
  )
...
var hasDuplicate = (ary) => {
  ...
  var cache = {}
  for (var i = 0; i < len; i++)
    if (!cache[String(ary[i])]) cache[String(ary[i])] = true
    else return true
  return false
}
...
var _excluded$16 = ['type', 'size', 'sizeType']
...
function _objectSpread$37(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2
      ? ownKeys$37(Object(t), !0).forEach(function (r) {
          _defineProperty$39(e, r, t[r])
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$37(Object(t)).forEach(function (r) {
...
function _objectWithoutProperties$16(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$16(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
...
var Symbols = (_ref) => {
  ...
  var props = _objectSpread$37(
    _objectSpread$37({}, _objectWithoutProperties$16(_ref, _excluded$16)),
    {},
    {
      type,
      size,
...
function Icon(_ref) {
  ...
  var preferredIcon =
    iconType !== null && iconType !== void 0 ? iconType : data.type
...
function Items(props) {
  ...
  return payload.map((entry, i) => {
    ...
    var finalLabelStyle =
      typeof labelStyle === 'object' ? _objectSpread$35({}, labelStyle) : {}
    finalLabelStyle.color = entry.inactive
      ? inactiveColor
      : finalLabelStyle.color || entry.color
    var finalValue = finalFormatter
...
var selectLegendPayload = createSelector(
...
var chartLayoutSlice = createSlice({
  ...
  reducers: {
    ...
    setMargin(state, action) {
      ...
      state.margin.top =
        (_action$payload$top = action.payload.top) !== null &&
        _action$payload$top !== void 0
          ? _action$payload$top
          : 0
      state.margin.right =
        (_action$payload$right = action.payload.right) !== null &&
        _action$payload$right !== void 0
          ? _action$payload$right
          : 0
      state.margin.bottom =
        (_action$payload$botto = action.payload.bottom) !== null &&
        _action$payload$botto !== void 0
          ? _action$payload$botto
          : 0
      state.margin.left =
        (_action$payload$left = action.payload.left) !== null &&
        _action$payload$left !== void 0
          ? _action$payload$left
          : 0
    },
...
var offsetSign = (series) => {
  ...
  if (n <= 0) return
  var m =
    (_series$ = series[0]) === null || _series$ === void 0
      ? void 0
      : _series$.length
...
var offsetPositive = (series) => {
  ...
  if (n <= 0) return
  var m =
    (_series$2 = series[0]) === null || _series$2 === void 0
      ? void 0
      : _series$2.length
  if (m == null || m <= 0) return
  for (var j = 0; j < m; ++j) {
...
function getTooltipEntry(_ref4) {
  ...
  return _objectSpread$34(
    _objectSpread$34({}, tooltipEntrySettings),
    {},
    {
      dataKey,
      payload,
...
function selectLeftAxesOffset(state) {
  return selectAllYAxes(state).reduce((result, entry) => {
    if (entry.orientation === 'left' && !entry.mirror && !entry.hide)
      return result + (typeof entry.width === 'number' ? entry.width : 60)
    return result
  }, 0)
}
...
var selectChartOffsetInternal = createSelector(
  ...
  (
    ...
    return _objectSpread$33(
      _objectSpread$33({ brushBottom }, offset),
      {},
      {
...
var selectChartViewBox = createSelector(
...
var selectAxisViewBox = createSelector(
  selectChartWidth,
  selectChartHeight,
  (width, height) => ({
    x: 0,
...
function getDefaultWidthAndHeight(_ref) {
  ...
  if (calculatedWidth === void 0 && calculatedHeight === void 0) {
    ...
    calculatedWidth =
      aspect && aspect > 0 ? void 0 : defaultResponsiveContainerProps.width
  else if (calculatedHeight === void 0)
    calculatedHeight =
      aspect && aspect > 0 ? void 0 : defaultResponsiveContainerProps.height
  return {
...
var ResponsiveContainerContext = /* @__PURE__ */ (0,
import_react.createContext)(defaultResponsiveContainerProps.initialDimension)
...
var SizeDetectorContainer = /* @__PURE__ */ (0, import_react.forwardRef)(
  (_ref2, ref) => {
    var {
      aspect,
    ...
    var setContainerSize = (0, import_react.useCallback)(
      (newWidth, newHeight) => {
        setSizes((prevState) => {
...
var useViewBox = () => {
  ...
  var brushPadding =
    (_useAppSelector = useAppSelector(selectBrushSettings)) === null ||
...
var useOffsetInternal = () => {
  ...
  return (_useAppSelector2 = useAppSelector(selectChartOffsetInternal)) !==
    null && _useAppSelector2 !== void 0
    ? _useAppSelector2
...
var _excluded$15 = ['contextPayload']
...
function _objectWithoutProperties$15(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$15(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
...
function LegendContent(props) {
  var { contextPayload } = props,
    otherProps = _objectWithoutProperties$15(props, _excluded$15)
  var finalPayload = getUniqPayload(
    contextPayload,
    props.payloadUniqBy,
    defaultUniqBy$1
  )
  var contentProps = _objectSpread$31(
    _objectSpread$31({}, otherProps),
    {},
    { payload: finalPayload }
  )
  if (/* @__PURE__ */ import_react.isValidElement(props.content))
...
function LegendImpl(outsideProps) {
  ...
  var maxWidth =
    chartWidth -
    ((margin === null || margin === void 0 ? void 0 : margin.left) || 0) -
    ((margin === null || margin === void 0 ? void 0 : margin.right) || 0)
  var widthOrHeight = getWidthOrHeight(
    props.layout,
    heightFromProps,
    widthFromProps,
    maxWidth
  )
  var outerStyle = portalFromProps
    ? wrapperStyle
    : _objectSpread$31(
        _objectSpread$31(
          {
            position: 'absolute',
            width:
              (widthOrHeight === null || widthOrHeight === void 0
                ? void 0
                : widthOrHeight.width) ||
              widthFromProps ||
              'auto',
  ...
  var legendPortal =
    portalFromProps !== null && portalFromProps !== void 0
      ? portalFromProps
      : legendPortalFromContext
  if (legendPortal == null || contextPayload == null) return null
  return /* @__PURE__ */ (0, import_react_dom.createPortal)(
    /* @__PURE__ */ import_react.createElement(
      'div',
      {
      ...
      /* @__PURE__ */ import_react.createElement(
        LegendContent,
        _extends$18({}, props, widthOrHeight, {
          margin,
          chartWidth,
          chartHeight,
          contextPayload
...
var DefaultTooltipContent = (props) => {
    ...
    if (payload && payload.length) {
      ...
      var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
        ...
        var finalItemStyle = _objectSpread$30(
          _objectSpread$30({}, defaultDefaultTooltipContentProps.itemStyle),
          {},
          {
            color:
              entry.color || defaultDefaultTooltipContentProps.itemStyle.color
          },
          itemStyle
        )
        return /* @__PURE__ */ import_react.createElement(
  ...
  var finalStyle = _objectSpread$30(
    _objectSpread$30({}, defaultDefaultTooltipContentProps.contentStyle),
    contentStyle
  )
...
function getTooltipTranslateXY(_ref2) {
  ...
  if (positive + tooltipDimension > viewBoxKey + viewBoxDimension)
    return Math.max(negative, viewBoxKey)
...
function usePrefersReducedMotion() {
  var [prefersReducedMotion, setPrefersReducedMotion] = (0,
...
function resolveTransitionProperty(args) {
  ...
  if (args.isAnimationActive && args.active)
    return 'transform '
      .concat(args.animationDuration, 'ms ')
      .concat(args.animationEasing)
}
function TooltipBoundingBoxImpl(props) {
  ...
  import_react.useEffect(() => {
      ...
      if (event.key === 'Escape') {
        ...
        setState({
          ...
          dismissedAtCoordinate: {
            x:
              (_props$coordinate$x =
                (_props$coordinate = props.coordinate) === null ||
                _props$coordinate === void 0
                  ? void 0
                  : _props$coordinate.x) !== null &&
              _props$coordinate$x !== void 0
                ? _props$coordinate$x
                : 0,
            y:
              (_props$coordinate$y =
                (_props$coordinate2 = props.coordinate) === null ||
                _props$coordinate2 === void 0
                  ? void 0
                  : _props$coordinate2.y) !== null &&
              _props$coordinate$y !== void 0
                ? _props$coordinate$y
                : 0
          }
        })
    ...
    (_props$coordinate3 = props.coordinate) === null ||
    _props$coordinate3 === void 0
      ? void 0
      : _props$coordinate3.x,
    (_props$coordinate4 = props.coordinate) === null ||
    _props$coordinate4 === void 0
      ? void 0
  ...
  if (
    state.dismissed &&
    (((_props$coordinate$x2 =
      (_props$coordinate5 = props.coordinate) === null ||
      _props$coordinate5 === void 0
        ? void 0
        : _props$coordinate5.x) !== null && _props$coordinate$x2 !== void 0
      ? _props$coordinate$x2
      : 0) !== state.dismissedAtCoordinate.x ||
      ((_props$coordinate$y2 =
        (_props$coordinate6 = props.coordinate) === null ||
        _props$coordinate6 === void 0
          ? void 0
    ...
    setState(
      _objectSpread$29(_objectSpread$29({}, state), {}, { dismissed: false })
    )
  var { cssClasses, cssProperties } = getTooltipTranslate({
    allowEscapeViewBox: props.allowEscapeViewBox,
    coordinate: props.coordinate,
    offsetLeft:
      typeof props.offset === 'number' ? props.offset : props.offset.x,
  ...
  var outerStyle = _objectSpread$29(
    _objectSpread$29(
      {},
    ...
    {
      visibility:
        !state.dismissed && props.active && props.hasPayload
          ? 'visible'
          : 'hidden'
    },
    props.wrapperStyle
...
var TooltipBoundingBox = /* @__PURE__ */ import_react.memo(
...
var useAccessibilityLayer = () => {
  var _useAppSelector
  return (_useAppSelector = useAppSelector(
...
var getCurveFactory = (type, layout) => {
  ...
  if ((name === 'curveMonotone' || name === 'curveBump') && layout) {
    var factory =
      CURVE_FACTORIES[''.concat(name).concat(layout === 'vertical' ? 'Y' : 'X')]
...
var getPath$1 = (_ref) => {
  ...
  if (Array.isArray(baseLine)) {
    ...
    var areaPoints = points.map((entry, index) =>
      _objectSpread$28(
        _objectSpread$28({}, entry),
        {},
        { base: baseLine[index] }
      )
    )
    if (layout === 'vertical')
      _lineFunction = area_default()
        .y(getY)
        .x1(getX)
        .x0((d) => d.base.x)
    else
      _lineFunction = area_default()
        ...
        .y1(getY)
        .y0((d) => d.base.y)
    return _lineFunction.defined(areaDefined).curve(curveFactory)(
...
var Curve = (props) => {
  ...
  return /* @__PURE__ */ import_react.createElement(
    'path',
    _extends$16({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
 ...
 * @fileOverview Cross
 */
var _excluded$14 = ['x', 'y', 'top', 'left', 'width', 'height', 'className']
...
function _objectWithoutProperties$14(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$14(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
...
var Cross = (_ref) => {
  var {
    ...
    rest = _objectWithoutProperties$14(_ref, _excluded$14)
  ...
  return /* @__PURE__ */ import_react.createElement(
    'path',
    _extends$15({}, svgPropertiesAndEvents(props), {
...
var getDashCase = (name) =>
  name.replace(/([A-Z])/g, (v) => '-'.concat(v.toLowerCase()))
var getTransitionVal = (props, duration, easing) =>
  props
    .map((prop) =>
      ''.concat(getDashCase(prop), ' ').concat(duration, 'ms ').concat(easing)
    )
    .join(',')
/**
...
function createStepperUpdate(
  ...
  var stepperUpdate = (now) => {
    ...
    render(
      _objectSpread$25(
        _objectSpread$25(_objectSpread$25({}, from), to),
        getCurrStyle()
      )
    )
    preTime = now
  ...
  return () => {
    ...
    return () => {
      var _stopAnimation
      ;(_stopAnimation = stopAnimation) === null ||
        _stopAnimation === void 0 ||
        _stopAnimation()
    }
  }
}
function createTimingUpdate(
  ...
  return () => {
    ...
    return () => {
      var _stopAnimation2
      ;(_stopAnimation2 = stopAnimation) === null ||
        _stopAnimation2 === void 0 ||
        _stopAnimation2()
    }
  }
}
var configUpdate_default = (
  from,
  to,
  easing,
  duration,
...
var configSpring = function configSpring() {
  ...
  var stepper = (currX, destX, currV) => {
    ...
    if (Math.abs(newX - destX) < 1e-4 && Math.abs(newV) < 1e-4)
      return [destX, 0]
    return [newX, newV]
  }
  ...
  var setStyle = (_style) => {
    ...
    if (Array.isArray(_style)) {
      ...
      if (typeof curr === 'number') {
        cancelTimeout = timeoutController.setTimeout(
...
var AnimationManagerContext = /* @__PURE__ */ (0, import_react.createContext)(
  createDefaultAnimationManager
)
function useAnimationManager(animationId, animationManagerFromProps) {
  var contextAnimationManager = (0, import_react.useContext)(
...
function JavascriptAnimate(outsideProps) {
  ...
  var isActive =
    isActiveProp === 'auto'
      ...
      : isActiveProp
  var animationManager = useAnimationManager(
    props.animationId,
...
function _objectWithoutProperties$13(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$13(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
...
var getRectanglePath = (x, y, width, height, radius) => {
  ...
  var maxRadius = Math.min(
    Math.abs(roundedWidth) / 2,
    Math.abs(roundedHeight) / 2
  )
  ...
  if (maxRadius > 0 && Array.isArray(radius)) {
    ...
    for (var i = 0, len = 4; i < len; i++) {
      var _radius$i
      var r =
        (_radius$i = radius[i]) !== null && _radius$i !== void 0 ? _radius$i : 0
      newRadius[i] = r > maxRadius ? maxRadius : r
    }
    path = roundTemplateLiteral(
      _templateObject$2 ||
        (_templateObject$2 = _taggedTemplateLiteral$2(['M', ',', ''])),
      x,
      y + ySign * newRadius[0]
    )
    if (newRadius[0] > 0)
    ...
    path += roundTemplateLiteral(
      _templateObject3$2 ||
        (_templateObject3$2 = _taggedTemplateLiteral$2(['L ', ',', ''])),
    ...
    if (newRadius[1] > 0)
      path += roundTemplateLiteral(
        _templateObject4$2 ||
          (_templateObject4$2 = _taggedTemplateLiteral$2([
            'A ',
            ',',
            ',0,0,',
            ',\n        ',
    ...
    path += roundTemplateLiteral(
      _templateObject5$2 ||
        (_templateObject5$2 = _taggedTemplateLiteral$2(['L ', ',', ''])),
      x + width,
    ...
    if (newRadius[2] > 0)
      path += roundTemplateLiteral(
        _templateObject6$1 ||
          (_templateObject6$1 = _taggedTemplateLiteral$2([
            'A ',
            ',',
            ',0,0,',
            ',\n        ',
    ...
    path += roundTemplateLiteral(
      _templateObject7$1 ||
        (_templateObject7$1 = _taggedTemplateLiteral$2(['L ', ',', ''])),
      x + xSign * newRadius[3],
      y + height
    )
    if (newRadius[3] > 0)
    ...
    path = roundTemplateLiteral(
      _templateObject9 ||
        (_templateObject9 = _taggedTemplateLiteral$2([
          'M ',
          ',',
          '\n            A ',
          ',',
    ...
    path = roundTemplateLiteral(
      _templateObject0 ||
        (_templateObject0 = _taggedTemplateLiteral$2([
          'M ',
          ',',
          ' h ',
          ' v ',
...
var Rectangle = (rectangleProps) => {
  ...
  var animationId = useAnimationId(
  ...
  if (!isUpdateAnimationActive) {
    var _svgPropertiesAndEven = svgPropertiesAndEvents(props),
      ...
      otherPathProps = _objectWithoutProperties$13(
        _svgPropertiesAndEven,
        _excluded$13
      )
    return /* @__PURE__ */ import_react.createElement(
      'path',
      _extends$14({}, otherPathProps, {
        x: round(x),
        y: round(y),
        width: round(width),
        height: round(height),
      ...
      return /* @__PURE__ */ import_react.createElement(
        ...
        _extends$14({}, otherPathProps, {
          ...
          style: _objectSpread$24(
            _objectSpread$24({}, animationStyle),
            props.style
          )
        })
      )
...
var getSectorPath = (_ref2) => {
  ...
  if (innerRadius > 0) {
    ...
    path += roundTemplateLiteral(
      _templateObject3$1 ||
        (_templateObject3$1 = _taggedTemplateLiteral$1(['L ', ',', ' Z'])),
      cx,
      cy
    )
  return path
...
var getSectorWithCorner = (_ref3) => {
  ...
  var path = roundTemplateLiteral(
    _templateObject5$1 ||
      (_templateObject5$1 = _taggedTemplateLiteral$1([
        'M ',
        ',',
        '\n    A',
        ',',
  ...
  if (innerRadius > 0) {
    ...
    path += roundTemplateLiteral(
      _templateObject6 ||
        (_templateObject6 = _taggedTemplateLiteral$1([
          'L',
          ',',
          '\n      A',
          ',',
    ...
    path += roundTemplateLiteral(
      _templateObject7 ||
        (_templateObject7 = _taggedTemplateLiteral$1(['L', ',', 'Z'])),
      cx,
      cy
    )
  return path
...
var Sector = (sectorProps) => {
  ...
  return /* @__PURE__ */ import_react.createElement(
    'path',
    _extends$13({}, svgPropertiesAndEvents(props), {
      className: layerClass,
      d: path
    })
  )
...
var selectChartDataAndAlwaysIgnoreIndexes = createSelector(
  ...
  (dataState) => {
    var dataEndIndex =
      dataState.chartData != null ? dataState.chartData.length - 1 : 0
    return {
...
var selectChartDataWithIndexesIfNotInPanoramaPosition3 = (
  state,
  _unused1,
  isPanorama
) => {
...
*/
function numericalDomainSpecifiedWithoutRequiringData(
  userDomain,
  allowDataOverflow
) {
...
function parseNumericalUserDomain(userDomain, dataDomain, allowDataOverflow) {
  ...
  if (Array.isArray(userDomain) && userDomain.length === 2) {
      ...
      try {
        if (dataDomain != null)
          finalMin = providedMin(
            dataDomain === null || dataDomain === void 0
              ? void 0
              : dataDomain[0]
          )
      } catch (_unused2) {}
    else if (
      typeof providedMin === 'string' &&
      MIN_VALUE_REG.test(providedMin)
    ) {
    ...
    if (providedMax === 'auto') {
      ...
      typeof providedMax === 'string' &&
      MAX_VALUE_REG.test(providedMax)
    ) {
...
var getSnap125Step = (roughStep, allowDecimals, correctionFactor) => {
  ...
  var exponent = Math.floor(
    new decimal_default(roughNum).abs().log(10).toNumber()
  )
  ...
  var formatStep = new decimal_default(
    (_NICE_STEPS$niceIdx = NICE_STEPS[niceIdx]) !== null &&
      _NICE_STEPS$niceIdx !== void 0
      ? _NICE_STEPS$niceIdx
      : 1
  ).mul(magnitude)
  return allowDecimals
...
var getTickOfSingleValue = (value, tickCount, allowDecimals) => {
  ...
  for (var i = 0; i < tickCount; i++)
    ticks.push(
      middle.add(new decimal_default(i - middleIndex).mul(step)).toNumber()
    )
  return ticks
}
/**
 ...
 */
var _calculateStep = function calculateStep(
  min,
  max,
  tickCount,
  allowDecimals
...
var getNiceTickValues = function getNiceTickValues(_ref2) {
  ...
  var { step, tickMin, tickMax } = _calculateStep(
    ...
    allowDecimals,
    0,
    niceTicksMode === 'snap125' ? getSnap125Step : getAdaptiveStep
  )
  var values = rangeStep(
    tickMin,
 ...
 * @return array of ticks
 */
var getTickValuesFixedDomain = function getTickValuesFixedDomain(
  _ref3,
  tickCount
) {
  var [min, max] = _ref3
...
var selectAngleAxis = createSelector(
  ...
  (angleAxisSettings, layout) => {
    ...
    return _objectSpread$22(
      _objectSpread$22({}, implicitAngleAxis),
      {},
      { type: evaluatedType }
    )
  }
  ...
  (radiusAxisSettings, layout) => {
    ...
    var evaluatedType =
      (_getAxisTypeBasedOnLa2 = getAxisTypeBasedOnLayout(
        ...
        : 'category'
    return _objectSpread$22(
      _objectSpread$22({}, implicitRadiusAxis),
      {},
      { type: evaluatedType }
    )
  }
...
var selectAngleAxisRange = createSelector(
  [selectPolarOptions],
...
function getStackSeriesIdentifier(graphicalItem) {
  return graphicalItem === null || graphicalItem === void 0
    ? void 0
    : graphicalItem.id
}
//#endregion
...
function isStacked(graphicalItem) {
  return (
    ...
    graphicalItem.stackId != null &&
    graphicalItem.dataKey != null
  )
}
//#endregion
...
function createCategoricalInverse(scale, allDataPointsOnAxis) {
  ...
  return (pixelValue) => {
    ...
    var leftPixel =
      (_pixelPositions = pixelPositions[index - 1]) !== null &&
      _pixelPositions !== void 0
        ? _pixelPositions
        : 0
    var rightPixel =
      (_pixelPositions$index = pixelPositions[index]) !== null &&
      _pixelPositions$index !== void 0
...
function combineInverseScaleFunction(configuredScale) {
  ...
  if (
    'invert' in configuredScale &&
    typeof configuredScale.invert === 'function'
  )
...
var selectUnfilteredCartesianItems = (state) =>
  state.graphicalItems.cartesianItems
var selectAxisPredicate = createSelector(
  [pickAxisType, pickAxisId],
  itemAxisPredicate
)
var combineGraphicalItemsSettings = (
  graphicalItems,
  axisSettings,
  axisPredicate
) =>
  graphicalItems.filter(axisPredicate).filter((item) => {
    if (
      (axisSettings === null || axisSettings === void 0
        ? void 0
        : axisSettings.includeHidden) === true
    )
      return true
    return !item.hide
  })
var selectCartesianItemsSettings = createSelector(
  ...
  { memoizeOptions: { resultEqualityCheck: emptyArraysAreEqualCheck } }
)
...
var filterGraphicalNotStackedItems = (cartesianItems) =>
  cartesianItems.filter(
    (item) => !('stackId' in item) || item.stackId === void 0
  )
...
var combineAppliedValues = (data, axisSettings, items) => {
  ...
  if (items.length > 0)
    return items
      ...
      .flatMap((dataKey) =>
        data.map((entry) => ({ value: getValueByDataKey(entry, dataKey) }))
      )
...
var selectSortedDataPoints = createSelector(
  [selectAllAppliedValues],
  (appliedData) => {
    return appliedData === null || appliedData === void 0
      ? void 0
      : appliedData.map((item) => item.value).sort(sortBy$1)
  }
)
...
var selectTooltipAxis = (state) => {
  return selectRenderableAxisSettings(
    state,
      ...
      return [
        stackId,
        {
          stackedData: getStackedData(
            displayedData,
            orderedGraphicalItems.map(getStackSeriesIdentifier),
            stackOffsetType
          ),
...
var combineDomainOfStackGroups = (
  stackGroups,
  _ref3,
  axisType,
  ...
  var domainOfStackGroups = getDomainOfStackGroups(
    stackGroups,
    dataStartIndex,
    dataEndIndex
  )
  if (
    domainOfStackGroups != null &&
    domainOfStackGroups[0] === 0 &&
    domainOfStackGroups[1] === 0
  )
    return
...
var getDomainDefinition = (axisSettings) => {
  ...
  return (_axisSettings$domain =
    axisSettings === null || axisSettings === void 0
      ? void 0
      : axisSettings.domain) !== null && _axisSettings$domain !== void 0
    ? _axisSettings$domain
    : defaultNumericDomain
}
var selectDomainDefinition = createSelector(
  [selectBaseAxis],
  getDomainDefinition
)
/**
...
var selectDomainOfStackGroups = createSelector(
  ...
  { memoizeOptions: { resultEqualityCheck: numberDomainEqualityCheck } }
)
var selectAllErrorBarSettings = (state) => state.errorBars
var combineRelevantErrorBarSettings = (
...
var combineDomainOfAllAppliedNumericalValuesIncludingErrorValues = (
    ...
    data.forEach((entry) => {
      items.forEach((item) => {
        ...
        var relevantErrorBars =
          (_errorBars$item$id = errorBars[item.id]) === null ||
          _errorBars$item$id === void 0
            ? void 0
        ...
        var errorDomain = getErrorDomainByDataKey(
          entry,
          valueByDataKey,
          relevantErrorBars
        )
  ...
  if (
    ...
    data.forEach((item) => {
      var dataValueDomain = makeDomain(
...
var computeDomainOfTypeCategory = (
  allDataSquished,
  axisSettings,
  isCategorical
) => {
...
var combineDotsDomain = (dots, axisType) => {
  ...
  var allCoords = onlyAllowNumbers(
    dots.map((dot) => (axisType === 'xAxis' ? dot.x : dot.y))
  )
...
var combineAxisDomain = (
  ...
  if (isCategorical && dataKey == null) {
    ...
    return (0, import_range.default)(
      0,
      (_displayedData$length =
        displayedData === null || displayedData === void 0
          ? void 0
          : displayedData.length) !== null && _displayedData$length !== void 0
        ? _displayedData$length
        : 0
    )
  }
  if (type === 'category')
    return computeDomainOfTypeCategory(
      allAppliedValues,
      axisSettings,
      isCategorical
    )
...
var combineAxisDomainWithNiceTicks = (
  axisSettings,
  domain,
  niceTicks,
  axisType
  ...
  if (
    ...
    var minFromTicks =
      (_niceTicks$ = niceTicks[0]) !== null && _niceTicks$ !== void 0
        ? _niceTicks$
        : 0
    var maxFromDomain = domain[1]
    var maxFromTicks =
      (_niceTicks = niceTicks[niceTicks.length - 1]) !== null &&
      _niceTicks !== void 0
        ? _niceTicks
        : 0
    return [
...
var selectCalculatedXAxisPadding = (state, axisId, isPanorama) => {
  ...
  if (xAxisSettings == null || typeof xAxisSettings.padding !== 'string')
    return 0
  return selectCalculatedPadding(
    state,
    'xAxis',
    axisId,
    isPanorama,
    xAxisSettings.padding
  )
}
...
var selectXAxisPadding = createSelector(
  ...
  (xAxisSettings, calculated) => {
    ...
    return {
      left:
        ((_padding$left = padding.left) !== null && _padding$left !== void 0
          ? _padding$left
          : 0) + calculated,
      right:
...
var selectYAxisPadding = createSelector(
  ...
  (yAxisSettings, calculated) => {
    ...
    return {
      top:
        ((_padding$top = padding.top) !== null && _padding$top !== void 0
          ? _padding$top
          : 0) + calculated,
      bottom:
        ((_padding$bottom = padding.bottom) !== null &&
        _padding$bottom !== void 0
          ? _padding$bottom
          : 0) + calculated
    }
  }
...
var selectAxisRange = (state, axisType, axisId, isPanorama) => {
  ...
  switch (axisType) {
    ...
    case 'zAxis':
      return (_selectZAxisSettings = selectZAxisSettings(state, axisId)) ===
        null || _selectZAxisSettings === void 0
        ? void 0
...
var selectXAxisSize = createSelector(
  selectChartOffsetInternal,
  selectXAxisSettings,
  getXAxisSize
)
...
var selectAllXAxesOffsetSteps = createSelector(
  ...
  (chartHeight, offset, allAxesWithSameOffsetType, orientation, mirror) => {
    ...
    allAxesWithSameOffsetType.forEach((axis) => {
      ...
      if (position == null)
        position = combineXAxisPositionStartingPoint(
          offset,
          orientation,
          chartHeight
        )
...
var selectAllYAxesOffsetSteps = createSelector(
  ...
  (chartWidth, offset, allAxesWithSameOffsetType, orientation, mirror) => {
    ...
    allAxesWithSameOffsetType.forEach((axis) => {
      ...
      if (position == null)
        position = combineYAxisPositionStartingPoint(
          offset,
          orientation,
          chartWidth
        )
...
var selectXAxisPosition = createSelector(
  ...
  (offset, axisSettings, allSteps, axisId) => {
    if (axisSettings == null) return
    var stepOfThisAxis =
      allSteps === null || allSteps === void 0 ? void 0 : allSteps[axisId]
...
var combineGraphicalItemTicks = (
  ...
  offset =
    axisType === 'angleAxis' &&
    (axisRange === null || axisRange === void 0 ? void 0 : axisRange.length) >=
      2
      ? mathSign(axisRange[0] - axisRange[1]) * 2 * offset
      : offset
  if (isCategorical && categoricalDomain)
 ...
 */
var selectAxisWithScale = createSelector(
  selectBaseAxis,
  selectAxisScale,
  (axis, scale) => {
    if (axis == null || scale == null) return
...
var selectChartDirection = createSelector(
  ...
  (layout, allXAxes, allYAxes) => {
    switch (layout) {
      case 'horizontal':
        return allXAxes.some((axis) => axis.reversed)
          ? 'right-to-left'
          : 'left-to-right'
      case 'vertical':
        return allYAxes.some((axis) => axis.reversed)
          ? 'bottom-to-top'
          : 'top-to-bottom'
      case 'centric':
      case 'radial':
...
var selectDefaultTooltipEventType = (state) =>
  state.options.defaultTooltipEventType
var selectValidateTooltipEventTypes = (state) =>
...
function combineTooltipEventType(
  ...
  return validateTooltipEventTypes.includes(eventType)
    ? eventType
    : defaultTooltipEventType
}
...
var tooltipSlice = createSlice({
  ...
  reducers: {
    ...
    removeTooltipEntrySettings: {
      reducer(state, action) {
        var index = current(state).tooltipItemPayloads.indexOf(
...
var combineTooltipInteractionState = (
  ...
  if (
    tooltipState.syncInteraction.active &&
    tooltipState.syncInteraction.index != null
  )
  ...
  if (hasBeenActivePreviously(appropriateMouseInteraction)) {
    if (activeFromProps)
      return _objectSpread$20(
        _objectSpread$20({}, appropriateMouseInteraction),
        {},
        { active: true }
      )
  ...
  return _objectSpread$20(
    _objectSpread$20({}, noInteraction),
    {},
...
function isValueWithinNumberDomain(value, domain) {
  ...
  return (
    numericValue >= Math.min(lowerBound, upperBound) &&
    numericValue <= Math.max(lowerBound, upperBound)
  )
}
...
var combineCoordinateForDefaultIndex = (
  ...
  var tick =
    tooltipTicks === null || tooltipTicks === void 0
      ? void 0
      : tooltipTicks[Number(defaultIndex)]
  if (!tick) return
  switch (layout) {
    case 'horizontal':
      return {
...
var selectTooltipPayloadSearcher = (state) =>
  ...
  return tooltipPayloadConfigurations.reduce((agg, _ref) => {
    ...
    var finalDataKey =
      (_settings$dataKey =
        settings === null || settings === void 0
          ? void 0
          : settings.dataKey) !== null && _settings$dataKey !== void 0
        ? _settings$dataKey
        : tooltipAxisDataKey
    var finalNameKey =
      settings === null || settings === void 0 ? void 0 : settings.nameKey
    var tooltipPayload
    if (
      tooltipAxisDataKey &&
    ...
    if (Array.isArray(tooltipPayload))
      tooltipPayload.forEach((item) => {
        ...
        var itemName =
          parsedItem === null || parsedItem === void 0
            ? void 0
            : parsedItem.name
        var itemDataKey =
          parsedItem === null || parsedItem === void 0
        ...
        var itemPayload =
          parsedItem === null || parsedItem === void 0
            ? void 0
            : parsedItem.payload
        var newSettings = _objectSpread$19(
          _objectSpread$19({}, settings),
          {},
          {
            name: itemName,
            unit:
            ...
            color:
              (_parsedItem$color =
                parsedItem === null || parsedItem === void 0
                  ? void 0
                  : parsedItem.color) !== null && _parsedItem$color !== void 0
                ? _parsedItem$color
                : settings === null || settings === void 0
                  ? void 0
                  : settings.color,
            fill:
              (_parsedItem$fill =
                parsedItem === null || parsedItem === void 0
                  ? void 0
                  : parsedItem.fill) !== null && _parsedItem$fill !== void 0
                ? _parsedItem$fill
                : settings === null || settings === void 0
                  ? void 0
                  : settings.fill
      ...
      agg.push(
        getTooltipEntry({
          ...
          name:
            (_getValueByDataKey = getValueByDataKey(
              tooltipPayload,
              finalNameKey
            )) !== null && _getValueByDataKey !== void 0
              ? _getValueByDataKey
              : settings === null || settings === void 0
                ? void 0
                : settings.name
...
var selectTooltipAxisDomainDefinition = createSelector(
  [selectTooltipAxis],
  getDomainDefinition
)
  ...
  [
    createSelector(
      [
        ...
        createSelector([selectAllGraphicalItemsSettings], (graphicalItems) =>
  ...
  (tooltipInteractionState) => {
    ...
    return (_tooltipInteractionSt =
      tooltipInteractionState === null || tooltipInteractionState === void 0
        ? void 0
        : tooltipInteractionState.active) !== null &&
...
var getActiveCartesianCoordinate = (
  layout,
  tooltipTicks,
  activeIndex,
  pointer
...
var calculateActiveTickIndex = (
  ...
  if (
    ...
    for (var i = 0; i < len; i++) {
      ...
      var before =
        i > 0
          ? (_unsortedTicks = unsortedTicks[i - 1]) === null ||
            _unsortedTicks === void 0
            ? void 0
            : _unsortedTicks.coordinate
          : (_unsortedTicks2 = unsortedTicks[len - 1]) === null ||
              _unsortedTicks2 === void 0
            ? void 0
            : _unsortedTicks2.coordinate
      var cur =
        (_unsortedTicks$i = unsortedTicks[i]) === null ||
        _unsortedTicks$i === void 0
          ? void 0
          : _unsortedTicks$i.coordinate
      var after =
        i >= len - 1
          ? (_unsortedTicks$ = unsortedTicks[0]) === null ||
            _unsortedTicks$ === void 0
            ? void 0
            : _unsortedTicks$.coordinate
          : (_unsortedTicks3 = unsortedTicks[i + 1]) === null ||
              _unsortedTicks3 === void 0
            ? void 0
      ...
      if (mathSign(cur - before) !== mathSign(after - cur)) {
        ...
        if (
          ...
          return (_unsortedTicks$i2 = unsortedTicks[i]) === null ||
            _unsortedTicks$i2 === void 0
            ? void 0
        ...
        if (
          ...
          return (_unsortedTicks$i3 = unsortedTicks[i]) === null ||
            _unsortedTicks$i3 === void 0
            ? void 0
...
var pickDefaultIndex = (_state, _tooltipEventType, _trigger, defaultIndex) =>
  defaultIndex
var selectOrderedTooltipTicks = createSelector(
  selectTooltipAxisTicks,
  (ticks) => (0, import_sortBy.default)(ticks, (o) => o.coordinate)
)
...
var selectActiveCoordinate = createSelector(
  ...
  (tooltipInteractionState, defaultIndexCoordinate) => {
    var _tooltipInteractionSt
    return (_tooltipInteractionSt = tooltipInteractionState.coordinate) !==
      null && _tooltipInteractionSt !== void 0
      ? _tooltipInteractionSt
...
var combineActiveCartesianProps = (
  ...
  var activeIndex = calculateActiveTickIndex(
    calculateCartesianTooltipPos(chartEvent, layout),
    orderedTooltipTicks,
    tooltipTicks,
    tooltipAxisType,
    tooltipAxisRange
...
var combineActivePolarProps = (
  ...
  var activeCoordinate = getActivePolarCoordinate(
    layout,
    tooltipTicks,
    activeIndex,
    rangeObj
...
function ZIndexLayer(_ref) {
  ...
  var shouldRenderInPortal =
    useIsInChartContext() && zIndex !== void 0 && zIndex !== 0
  var isPanorama = useIsPanorama()
  var dispatch = useAppDispatch()
...
function RenderCursor(_ref) {
  ...
  if (/* @__PURE__ */ (0, import_react.isValidElement)(cursor))
    return /* @__PURE__ */ (0, import_react.cloneElement)(cursor, cursorProps)
...
function CursorInternal(props) {
  ...
  if (chartName === 'ScatterChart') {
    ...
    var { cx, cy, radius, startAngle, endAngle } =
  ...
  var extraClassName =
    typeof cursor === 'object' && 'className' in cursor
      ? cursor.className
      : void 0
  var cursorProps = _objectSpread$15(
    _objectSpread$15(
      _objectSpread$15(
        _objectSpread$15(
          {
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    /* @__PURE__ */ import_react.createElement(RenderCursor, {
      cursor,
      cursorComp,
      cursorProps
    })
...
var { setChartData, setDataStartEndIndexes, setComputedData } =
...
function _objectWithoutProperties$12(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$12(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
      ...
      if (syncMethod === 'index') {
        ...
        if (
          ...
          var _action$payload$coord = action.payload.coordinate,
            ...
            otherCoordinateProps = _objectWithoutProperties$12(
          ...
          var scaledCoordinate = _objectSpread$14(
            _objectSpread$14({}, otherCoordinateProps),
            {},
            {
              x:
                viewBox.x +
                (sourceWidth ? (_x - sourceX) / sourceWidth : 0) *
                  viewBox.width,
              y:
                viewBox.y +
                (sourceHeight ? (_y - sourceY) / sourceHeight : 0) *
                  viewBox.height
            }
          )
          dispatch(
            _objectSpread$14(
              _objectSpread$14({}, action),
              {},
              {
                payload: _objectSpread$14(
                  _objectSpread$14({}, action.payload),
                  {},
...
function useTooltipChartSynchronisation(
  ...
  var isReceivingSynchronisation =
    tooltipState === null || tooltipState === void 0
      ? void 0
      : tooltipState.active
  var viewBox = useViewBox()
  ;(0, import_react.useEffect)(() => {
    ...
    var syncAction = setSyncInteraction({
      ...
      index: activeIndex,
      label:
        typeof activeLabel === 'number' ? String(activeLabel) : activeLabel,
...
function Tooltip(outsideProps) {
  ...
  var finalIsActive =
    (_ref =
      activeFromProps !== null && activeFromProps !== void 0
        ? activeFromProps
        : isActive) !== null && _ref !== void 0
      ? _ref
      : false
  var [lastBoundingBox, updateBoundingBox] = useElementOffset([
    payload,
    finalIsActive
  ])
  ...
  if (tooltipPortal == null || viewBox == null || tooltipEventType == null)
    return null
  var finalPayload =
    payload !== null && payload !== void 0 ? payload : emptyPayload
  ...
  var tooltipContentProps = _objectSpread$13(
  ...
  var tooltipElement = /* @__PURE__ */ import_react.createElement(
    TooltipBoundingBox,
    {
      allowEscapeViewBox,
      animationDuration,
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    null,
    /* @__PURE__ */ (0, import_react_dom.createPortal)(
      tooltipElement,
      tooltipPortal
    ),
    finalIsActive &&
      /* @__PURE__ */ import_react.createElement(Cursor, {
        cursor,
        tooltipEventType,
        coordinate,
        payload: finalPayload,
...
function _objectWithoutProperties$11(e, t) {
  ...
  var o,
    r,
    i = _objectWithoutPropertiesLoose$11(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
...
var Text = /* @__PURE__ */ (0, import_react.forwardRef)((outsideProps, ref) => {
  var _resolveDefaultProps = resolveDefaultProps(
      outsideProps,
      textDefaultProps
    ),
    {
    ...
    props = _objectWithoutProperties$11(_resolveDefaultProps, _excluded$11)
  ...
  var { dx, dy, angle, className, breakAll } = props,
    textProps = _objectWithoutProperties$11(props, _excluded2$5)
  ...
  if (scaleToFit && firstLine != null) {
    ...
    transforms.push(
      'scale('.concat(
        isNumber(width) && isNumber(lineWidth) ? width / lineWidth : 1,
        ')'
      )
    )
  }
  ...
  return /* @__PURE__ */ import_react.createElement(
    'text',
    _extends$11({}, svgPropertiesAndEvents(textProps), {
      ref,
      x,
      y,
...
var getCartesianPosition = (options) => {
  ...
  var { x, y, height, upperWidth, lowerWidth } =
  ...
  if (position === 'right') {
    ...
    if (clamp && parentViewBox) {
      _result3.width = Math.max(
        parentViewBox.x + parentViewBox.width - _result3.x,
        0
      )
...
var _excluded$10 = ['labelRef'],
  _excluded2$4 = ['content']
function _objectWithoutProperties$10(e, t) {
  if (null == e) return {}
  var o,
    r,
    i = _objectWithoutPropertiesLoose$10(e, t)
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e)
    for (r = 0; r < n.length; r++)
      ((o = n[r]),
 ...
 * @inline
 */
var CartesianLabelContext = /* @__PURE__ */ (0, import_react.createContext)(
  null
)
...
var useCartesianLabelContext = () => {
  ...
  return (
    labelChildContext ||
    (chartContext ? cartesianViewBoxToTrapezoid(chartContext) : void 0)
  )
}
...
var renderRadialLabel = (labelProps, position, label, attrs, viewBox) => {
  ...
  var { cx, cy, innerRadius, outerRadius, startAngle, endAngle, clockWise } =
    viewBox
  ...
  var path = 'M'
    ...
    .concat(endPoint.x, ',')
    .concat(endPoint.y)
  var id = isNullish(labelProps.id)
...
var getAttrsOfPolarLabel = (viewBox, offset, position) => {
  ...
  if (position === 'outside') {
    var { x: _x, y: _y } = polarToCartesian(
      cx,
      cy,
      outerRadius + offset,
      midAngle
...
var isPolar = (viewBox) =>
  viewBox != null && 'cx' in viewBox && isNumber(viewBox.cx)
...
function Label(outerProps) {
  ...
  if (
    ...
    return null
  var propsWithViewBox = _objectSpread$10(
    _objectSpread$10({}, props),
    {},
    { viewBox }
  )
  if (/* @__PURE__ */ (0, import_react.isValidElement)(content)) {
    ...
    return /* @__PURE__ */ (0, import_react.cloneElement)(
      content,
      _objectWithoutProperties$10(propsWithViewBox, _excluded$10)
    )
  }
  if (typeof content === 'function') {
    var { content: _2 } = propsWithViewBox
    label = /* @__PURE__ */ (0, import_react.createElement)(
      content,
      _objectWithoutProperties$10(propsWithViewBox, _excluded2$4)
    )
  ...
  if (isPolar(viewBox)) {
    ...
    positionAttrs = _objectSpread$10(
      _objectSpread$10(
        {
          x: cartesianResult.x,
          y: cartesianResult.y,
        ...
        cartesianResult.width !== void 0 ? { width: cartesianResult.width } : {}
      ),
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (label === true)
    return /* @__PURE__ */ import_react.createElement(
      Label,
      _extends$10({ key: 'label-implicit' }, commonProps)
    )
  if (isNumOrStr(label))
    return /* @__PURE__ */ import_react.createElement(
      Label,
  ...
  if (/* @__PURE__ */ (0, import_react.isValidElement)(label)) {
    if (label.type === Label)
      return /* @__PURE__ */ (0, import_react.cloneElement)(
        label,
        _objectSpread$10({ key: 'label-implicit' }, commonProps)
      )
    return /* @__PURE__ */ import_react.createElement(
      Label,
      _extends$10(
  ...
  if (label && typeof label === 'object')
    return /* @__PURE__ */ import_react.createElement(
      Label,
      _extends$10({}, label, { key: 'label-implicit' }, commonProps)
    )
  return null
}
...
var _excluded$9 = ['valueAccessor'],
  _excluded2$3 = ['dataKey', 'clockWise', 'id', 'textBreakAll', 'zIndex']
function _extends$9() {
  return (
...
var defaultAccessor = (entry) => {
  var val = Array.isArray(entry.value)
    ? entry.value[entry.value.length - 1]
    : entry.value
  if (isRenderableText(val)) return val
}
var CartesianLabelListContext = /* @__PURE__ */ (0, import_react.createContext)(
  void 0
)
var CartesianLabelListContextProvider = CartesianLabelListContext.Provider
var PolarLabelListContext = /* @__PURE__ */ (0, import_react.createContext)(
  void 0
)
...
function LabelList(_ref) {
  ...
  var { dataKey, clockWise, id, textBreakAll, zIndex } = restProps,
    others = _objectWithoutProperties$9(restProps, _excluded2$3)
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    {
      zIndex:
        zIndex !== null && zIndex !== void 0 ? zIndex : DefaultZIndexes.label
    },
    /* @__PURE__ */ import_react.createElement(
      Layer,
      ...
      data.map((entry, index) => {
        ...
        return /* @__PURE__ */ import_react.createElement(
          ...
          _extends$9(
            ...
            {
              fill:
                (_restProps$fill = restProps.fill) !== null &&
                _restProps$fill !== void 0
                  ? _restProps$fill
                  : entry.fill,
...
function LabelListFromLabelProp(_ref2) {
  ...
  if (typeof label === 'object')
    return /* @__PURE__ */ import_react.createElement(
      LabelList,
      _extends$9({ key: 'labelList-implicit' }, label, {
...
var { addRadiusAxis, removeRadiusAxis, addAngleAxis, removeAngleAxis } =
...
var getTrapezoidPath = (x, y, upperWidth, lowerWidth, height) => {
  ...
  path += roundTemplateLiteral(
    _templateObject2 ||
      (_templateObject2 = _taggedTemplateLiteral(['L ', ',', ''])),
    x + upperWidth,
    y
  )
  path += roundTemplateLiteral(
  ...
  path += roundTemplateLiteral(
    _templateObject4 ||
      (_templateObject4 = _taggedTemplateLiteral(['L ', ',', ''])),
    x + upperWidth - widthGap / 2 - lowerWidth,
    y + height
  )
  path += roundTemplateLiteral(
    _templateObject5 ||
      (_templateObject5 = _taggedTemplateLiteral(['L ', ',', ' Z'])),
    x,
    y
  )
  return path
...
var Trapezoid = (outsideProps) => {
  ...
  if (!isUpdateAnimationActive)
    return /* @__PURE__ */ import_react.createElement(
      ...
      /* @__PURE__ */ import_react.createElement(
        'path',
        _extends$8({}, svgPropertiesAndEvents(trapezoidProps), {
          className: layerClass,
      ...
      return /* @__PURE__ */ import_react.createElement(
        ...
        _extends$8({}, svgPropertiesAndEvents(trapezoidProps), {
          ...
          style: _objectSpread$9(
            _objectSpread$9({}, animationStyle),
...
function ShapeSelector(_ref) {
  ...
  switch (shapeType) {
    ...
    case 'symbols':
      ...
      break
    case 'curve':
      return /* @__PURE__ */ import_react.createElement(Curve, elementProps)
    default:
      return null
  }
}
...
var useId =
  (_ref = import_react['useId'.toString()]) !== null && _ref !== void 0
    ? _ref
    : useIdFallback
//#endregion
...
var GraphicalItemIdContext = /* @__PURE__ */ (0, import_react.createContext)(
  void 0
)
...
var graphicalItemsSlice = createSlice({
  ...
  reducers: {
    ...
    removeCartesianGraphicalItem: {
      reducer(state, action) {
        var index = current(state).cartesianItems.indexOf(
          castDraft(action.payload)
        )
...
var SetCartesianGraphicalItem = /* @__PURE__ */ (0, import_react.memo)(
    ...
    updateYAxisWidth(state, action) {
      ...
      if (axis) {
        ...
        if (
          ...
          Math.abs(
            width -
              ((_history$ = history[0]) !== null && _history$ !== void 0
                ? _history$
                : 0)
          ) <= 1
        )
        ...
        state.yAxis[id] = _objectSpread$7(
          _objectSpread$7({}, axis),
          {},
          {
            width,
  ...
  var stackedSizeList = Object.entries(groupByStack).map((_ref) => {
    ...
    return {
      ...
      barSize: getBarSize(
        globalSize,
        totalSize,
        (_bars$ = bars[0]) === null || _bars$ === void 0
          ? void 0
          : _bars$.barSize
      )
    }
...
function getBarPositions(
  ...
  if (
    isWellBehavedNumber(
      (_sizeList$ = sizeList[0]) === null || _sizeList$ === void 0
        ? void 0
        : _sizeList$.barSize
    )
  ) {
    ...
    result = sizeList.reduce((res, entry) => {
      ...
      var newPosition = {
        ...
        position: {
          ...
          size: useFull
            ? fullBarSize
            : (_entry$barSize = entry.barSize) !== null &&
                _entry$barSize !== void 0
              ? _entry$barSize
              : 0
        }
      }
    ...
    var size = isWellBehavedNumber(maxBarSize)
...
var combineAllBarPositions = (
  ...
  var maxBarSize = isNullish(childMaxBarSize)
    ? globalMaxBarSize
    : childMaxBarSize
  ...
  if (barBandSize !== bandSize && allBarPositions != null)
    allBarPositions = allBarPositions.map((pos) =>
      _objectSpread$6(
        ...
        {},
        {
          position: _objectSpread$6(
            _objectSpread$6({}, pos.position),
            {},
...
var referenceElementsSlice = createSlice({
  ...
  reducers: {
    ...
    removeArea: (state, action) => {
      var index = current(state).areas.findIndex(
    ...
    removeLine: (state, action) => {
      var index = current(state).lines.findIndex(
...
var ClipPathProvider = (_ref) => {
  var { children } = _ref
  var [clipPathId] = (0, import_react.useState)(
    ''.concat(uniqueId('recharts'), '-clip')
  )
...
function getTicks(props, fontSize, letterSpacing) {
  ...
  if (interval === 'equidistantPreserveEnd')
    return getEquidistantPreserveEndTicks(
      sign,
      boundaries,
      getTickSize,
      ticks,
...
function AxisLine(axisLineProps) {
  var { x, y, width, height, orientation, mirror, axisLine, otherSvgProps } =
    axisLineProps
  if (!axisLine) return null
  var props = _objectSpread$4(
    _objectSpread$4(
      _objectSpread$4({}, otherSvgProps),
...
function TickItem(props) {
  ...
  if (/* @__PURE__ */ import_react.isValidElement(option))
    ...
    tickItem = /* @__PURE__ */ import_react.createElement(
      Text,
      _extends$7({}, tickProps, { className }),
      value
    )
  }
  return tickItem
...
var Ticks = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
  ...
  var finalTicks = getTicks(
    _objectSpread$4(_objectSpread$4({}, getTicksConfig), {}, { ticks }),
    fontSize,
    letterSpacing
  )
  ...
  var tickLines = tickLineCoords.map((_ref2) => {
    ...
    return /* @__PURE__ */ import_react.createElement(
      ...
      tickLine &&
        /* @__PURE__ */ import_react.createElement(
          'line',
          _extends$7({}, tickLineProps, lineCoord, {
            className: clsx(
  ...
  var tickLabels = tickLineCoords.map((_ref3, i) => {
    ...
    var finalTickProps = _objectSpread$4(
      _objectSpread$4(
        {},
        _objectSpread$4(
          _objectSpread$4(
            _objectSpread$4(
              _objectSpread$4({ verticalAnchor }, axisProps),
              {},
              {
                textAnchor,
                stroke: 'none',
            ...
            angle:
              (_ref4 =
                (_tickTextProps$angle =
                  tickTextProps === null || tickTextProps === void 0
                    ? void 0
                    : tickTextProps.angle) !== null &&
                _tickTextProps$angle !== void 0
                  ? _tickTextProps$angle
    ...
    return /* @__PURE__ */ import_react.createElement(
      ...
      tick &&
        /* @__PURE__ */ import_react.createElement(TickItem, {
          option: tick,
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    /* @__PURE__ */ import_react.createElement(RenderedTicksReporter, {
      ticks: finalTicks,
      axisId,
      axisType
    }),
...
var CartesianAxisComponent = /* @__PURE__ */ (0, import_react.forwardRef)(
  (props, ref) => {
    var { axisLine, width, height, className, hide, ticks, axisType, axisId } =
        props,
    ...
    ;(0, import_react.useImperativeHandle)(ref, () => ({
      getCalculatedWidth: () => {
        ...
        return getCalculatedYAxisWidth({
          ...
          label:
            (_props$labelRef = props.labelRef) === null ||
            _props$labelRef === void 0
              ? void 0
    ...
    var layerRef = (0, import_react.useCallback)(
      (el) => {
        if (el) {
          var tickNodes = el.getElementsByClassName(
            'recharts-cartesian-axis-tick-value'
          )
          ...
          if (tick) {
            ...
            if (
              ...
              calculatedLetterSpacing !== letterSpacing
            ) {
    ...
    replaceErrorBar: (state, action) => {
      ...
      if (state[itemId])
        state[itemId] = state[itemId].map((e) =>
          e.dataKey === prev.dataKey && e.direction === prev.direction
            ? next
            : e
        )
    },
    removeErrorBar: (state, action) => {
      ...
      if (state[itemId])
        state[itemId] = state[itemId].filter(
          (e) =>
            e.dataKey !== errorBar.dataKey || e.direction !== errorBar.direction
        )
    }
  }
})
...
function useNeedsClip(xAxisId, yAxisId) {
  ...
  var needClipX =
    (_xAxis$allowDataOverf =
      xAxis === null || xAxis === void 0 ? void 0 : xAxis.allowDataOverflow) !==
      null && _xAxis$allowDataOverf !== void 0
      ? _xAxis$allowDataOverf
      : implicitXAxis.allowDataOverflow
  var needClipY =
    (_yAxis$allowDataOverf =
      yAxis === null || yAxis === void 0 ? void 0 : yAxis.allowDataOverflow) !==
      null && _yAxis$allowDataOverf !== void 0
      ? _yAxis$allowDataOverf
...
function selectXAxisIdFromGraphicalItemId(state, id) {
  ...
  return (_state$graphicalItems =
    (_state$graphicalItems2 = state.graphicalItems.cartesianItems.find(
      ...
      ? void 0
      : _state$graphicalItems2.xAxisId) !== null &&
    _state$graphicalItems !== void 0
...
function selectYAxisIdFromGraphicalItemId(state, id) {
  ...
  return (_state$graphicalItems3 =
    (_state$graphicalItems4 = state.graphicalItems.cartesianItems.find(
      ...
      ? void 0
      : _state$graphicalItems4.yAxisId) !== null &&
    _state$graphicalItems3 !== void 0
...
var selectMaxBarSize = createSelector(
  [selectSynchronisedBarSettings],
  (barSettings) =>
    barSettings === null || barSettings === void 0
      ? void 0
      : barSettings.maxBarSize
)
...
var _excluded$4 = ['onMouseEnter', 'onMouseLeave', 'onClick'],
  _excluded2$2 = ['value', 'background', 'tooltipPosition'],
  _excluded3$1 = ['id'],
...
var SetBarTooltipEntrySettings = /* @__PURE__ */ import_react.memo((_ref) => {
  ...
  return /* @__PURE__ */ import_react.createElement(SetTooltipEntrySettings, {
...
function BarBackground(props) {
  ...
  var {
    ...
    restOfAllOtherProps = _objectWithoutProperties$4(
      allOtherBarProps,
      _excluded$4
    )
  ...
  return /* @__PURE__ */ import_react.createElement(
    ZIndexLayer,
    {
      zIndex: getZIndexFromUnknown(
        backgroundFromProps,
        DefaultZIndexes.barBackground
      )
    },
    data.map((entry, i) => {
      var {
        ...
        rest = _objectWithoutProperties$4(entry, _excluded2$2)
      if (!backgroundFromDataEntry) return null
      var onMouseEnter = onMouseEnterFromContext(entry, i)
      var onMouseLeave = onMouseLeaveFromContext(entry, i)
      var onClick = onClickFromContext(entry, i)
      var barRectangleProps = _objectSpread$3(
        _objectSpread$3(
          _objectSpread$3(
            _objectSpread$3(
              _objectSpread$3(
      ...
      return /* @__PURE__ */ import_react.createElement(
        BarRectangle,
        _extends$4({ key: 'background-bar-'.concat(i) }, barRectangleProps)
      )
    })
  )
}
...
function BarRectangleWithActiveState(props) {
  ...
  var [hasMountedActive, setHasMountedActive] = (0, import_react.useState)(
    false
  )
  ;(0, import_react.useEffect)(() => {
    var rafId
  ...
  var content = /* @__PURE__ */ import_react.createElement(
    BarRectangle,
    _extends$4({}, baseProps, { name: String(baseProps.name) }, entry, {
...
function BarRectangles(_ref3) {
  ...
  var _ref4 =
      ...
      _svgPropertiesNoEvent !== void 0
        ...
        : {},
    { id } = _ref4,
    baseProps = _objectWithoutProperties$4(_ref4, _excluded3$1)
  ...
  var {
    ...
    restOfAllOtherProps = _objectWithoutProperties$4(props, _excluded4)
  var onMouseEnterFromContext = useMouseEnterItemDispatch(
    onMouseEnterFromProps,
    dataKey,
    id
...
function RectanglesWithAnimation(_ref5) {
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    /* @__PURE__ */ import_react.createElement(
      ...
      (t) => {
        ...
        return /* @__PURE__ */ import_react.createElement(
          Layer,
          null,
          /* @__PURE__ */ import_react.createElement(BarRectangles, {
            props,
            data: stepData
          })
        )
    ...
    /* @__PURE__ */ import_react.createElement(LabelListFromLabelProp, {
      label: props.label
    }),
    props.children
  )
    ...
    return /* @__PURE__ */ import_react.createElement(
      ...
      needClip &&
        /* @__PURE__ */ import_react.createElement(
          'defs',
          null,
          /* @__PURE__ */ import_react.createElement(GraphicalItemClipPath, {
            clipPathId,
            xAxisId,
            yAxisId
          })
...
function BarImpl(props) {
  ...
  var rects = useAppSelector((state) =>
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    (id) =>
      /* @__PURE__ */ import_react.createElement(
        import_react.Fragment,
        null,
        /* @__PURE__ */ import_react.createElement(SetLegendPayload, {
          legendPayload: computeLegendPayloadFromBarData(props)
        }),
        /* @__PURE__ */ import_react.createElement(SetBarTooltipEntrySettings, {
...
var _excluded$3 = ['domain', 'range'],
  _excluded2$1 = ['domain', 'range']
...
function axisPropsAreEqual(prevProps, nextProps) {
  ...
  var { domain: prevDomain, range: prevRange } = prevProps,
    prevRest = _objectWithoutProperties$3(prevProps, _excluded$3)
  var { domain: nextDomain, range: nextRange } = nextProps,
    nextRest = _objectWithoutProperties$3(nextProps, _excluded2$1)
...
var XAxisImpl = (props) => {
  ...
  var { id, scale: del2 } = synchronizedSettings,
    restSynchronizedSettings = _objectWithoutProperties$2(
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    _extends$3({}, allOtherProps, restSynchronizedSettings, {
      ...
      className: clsx(
        'recharts-'.concat(axisType, ' ').concat(axisType),
        className
      ),
      viewBox,
...
var XAxisSettingsDispatcher = (outsideProps) => {
  ...
  return /* @__PURE__ */ import_react.createElement(
    import_react.Fragment,
    null,
    /* @__PURE__ */ import_react.createElement(SetXAxisSettings, {
 ...
 */
var XAxis = /* @__PURE__ */ import_react.memo(
...
function isSvgPointer(pointer) {
  return (
    'getBBox' in pointer.currentTarget &&
    typeof pointer.currentTarget.getBBox === 'function'
  )
}
/**
...
mouseClickMiddleware.startListening({
  ...
  effect: (action, listenerApi) => {
    ...
    if (
      (activeProps === null || activeProps === void 0
        ? void 0
        : activeProps.activeIndex) != null
    )
...
mouseMoveMiddleware.startListening({
  ...
  effect: (action, listenerApi) => {
    var mousePointer = action.payload
    var { throttleDelay, throttledEvents } =
      listenerApi.getState().eventSettings
    var isThrottled =
      throttledEvents === 'all' ||
...
function reduxDevtoolsJsonStringifyReplacer(key, value) {
  if (value instanceof HTMLElement)
    return 'HTMLElement <'
      .concat(value.tagName, ' class="')
      .concat(value.className, '">')
...
var rootPropsSlice = createSlice({
  ...
  reducers: {
    updateOptions: (state, action) => {
      ...
      state.barGap =
        (_action$payload$barGa = action.payload.barGap) !== null &&
        _action$payload$barGa !== void 0
...
keyboardEventsMiddleware.startListening({
  ...
  effect: (action, listenerApi) => {
    ...
    var { throttleDelay, throttledEvents } =
      listenerApi.getState().eventSettings
    var isThrottled =
      throttledEvents === 'all' || throttledEvents.includes('keydown')
    if (
      timeoutId$1 !== null &&
      (typeof throttleDelay !== 'number' || !isThrottled)
    ) {
    ...
    var callback = () => {
      try {
        ...
        var directionMultiplier =
          selectChartDirection(currentState) === 'left-to-right' ? 1 : -1
        var nextIndex =
          currentIndex + (key === 'ArrowRight' ? 1 : -1) * directionMultiplier
        if (
          tooltipTicks == null ||
...
touchEventMiddleware.startListening({
  ...
  effect: (action, listenerApi) => {
    ...
    var { throttleDelay, throttledEvents } =
      listenerApi.getState().eventSettings
    var isThrottled =
      throttledEvents === 'all' || throttledEvents.includes('touchmove')
    if (rafId !== null) {
      cancelAnimationFrame(rafId)
      rafId = null
    }
    ...
    var callback = () => {
      ...
      if (tooltipEventType === 'axis') {
        ...
        var latestTouchPointer =
          (_latestChartPointers = latestChartPointers) === null ||
          _latestChartPointers === void 0
            ? void 0
        ...
        var coordinate = selectTooltipCoordinate(
          currentState,
          itemIndex,
          graphicalItemId
        )
    ...
    middleware: (getDefaultMiddleware) => {
      ...
      return getDefaultMiddleware({
        ...
        immutableCheck: !['commonjs', 'es6', 'production'].includes(
          (_process$env$NODE_ENV = 'es6') !== null &&
...
var ReportMainChartProps = /* @__PURE__ */ (0, import_react.memo)(
...
var ReportEventSettings = /* @__PURE__ */ (0, import_react.memo)(
  ReportEventSettingsImpl,
  propsAreEqual
)
//#endregion
...
function AllZIndexPortals(_ref2) {
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    allNegativeZIndexes.map((zIndex) =>
      /* @__PURE__ */ import_react.createElement(ZIndexSvgPortal, {
        key: zIndex,
        zIndex,
        isPanorama
      })
...
var MainChartSurface = /* @__PURE__ */ (0, import_react.forwardRef)(
  (props, ref) => {
...
var ResponsiveDiv = /* @__PURE__ */ (0, import_react.forwardRef)(
  (props, ref) => {
    ...
    var innerRef = (0, import_react.useCallback)(
      (node) => {
    ...
    return /* @__PURE__ */ import_react.createElement(
      ...
      /* @__PURE__ */ import_react.createElement(
        'div',
        _extends$1({ ref: innerRef }, props)
      )
    )
  }
)
var ReadSizeOnceDiv = /* @__PURE__ */ (0, import_react.forwardRef)(
  (props, ref) => {
    var { width, height } = props
    var [sizes, setSizes] = (0, import_react.useState)({
...
var StaticDiv = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    /* @__PURE__ */ import_react.createElement(
      'div',
      _extends$1({ ref }, props)
    )
  )
})
var NonResponsiveDiv = /* @__PURE__ */ (0, import_react.forwardRef)(
  (props, ref) => {
    var { width, height } = props
    if (typeof width === 'string' || typeof height === 'string')
      return /* @__PURE__ */ import_react.createElement(
        ReadSizeOnceDiv,
        _extends$1({}, props, { ref })
      )
...
var RechartsWrapper = /* @__PURE__ */ (0, import_react.forwardRef)(
  (props, ref) => {
    var {
      children,
      className,
    ...
    var responsiveContainerCalculations = useResponsiveContainerContext()
    var width =
      (responsiveContainerCalculations === null ||
      responsiveContainerCalculations === void 0
        ? void 0
        : responsiveContainerCalculations.width) > 0
        ? responsiveContainerCalculations.width
        : widthFromProps
    ...
    var myOnClick = (0, import_react.useCallback)(
      (e) => {
    ...
    var myOnMouseEnter = (0, import_react.useCallback)(
      (e) => {
    ...
    var myOnMouseLeave = (0, import_react.useCallback)(
      (e) => {
    ...
    var myOnMouseMove = (0, import_react.useCallback)(
      (e) => {
        dispatch(mouseMoveAction(e))
        dispatch(
          externalEventAction({
    ...
    var onKeyDown = (0, import_react.useCallback)(
      (e) => {
        dispatch(keyDownAction(e.key))
      },
      [dispatch]
    )
    var myOnContextMenu = (0, import_react.useCallback)(
      (e) => {
        dispatch(
          externalEventAction({
    ...
    var myOnDoubleClick = (0, import_react.useCallback)(
      (e) => {
        dispatch(
          externalEventAction({
    ...
    var myOnMouseDown = (0, import_react.useCallback)(
      (e) => {
        dispatch(
          externalEventAction({
            handler: onMouseDown,
    ...
    var myOnMouseUp = (0, import_react.useCallback)(
      (e) => {
        dispatch(
          externalEventAction({
            handler: onMouseUp,
    ...
    var myOnTouchStart = (0, import_react.useCallback)(
      (e) => {
        dispatch(
          externalEventAction({
    ...
    var myOnTouchMove = (0, import_react.useCallback)(
      (e) => {
    ...
    var myOnTouchEnd = (0, import_react.useCallback)(
      (e) => {
        dispatch(
          externalEventAction({
            handler: onTouchEnd,
    ...
    return /* @__PURE__ */ import_react.createElement(
      ...
      /* @__PURE__ */ import_react.createElement(
        ...
        /* @__PURE__ */ import_react.createElement(
          ...
          /* @__PURE__ */ import_react.createElement(EventSynchronizer, null),
          children
        )
      )
    )
...
var CategoricalChart = /* @__PURE__ */ (0, import_react.forwardRef)(
  (props, ref) => {
    ...
    var attrs = svgPropertiesNoEvents(
    ...
    return /* @__PURE__ */ import_react.createElement(
      RechartsWrapper,
      {
        ...
        height,
        responsive:
          responsive !== null && responsive !== void 0 ? responsive : false,
 ...
 */
var CartesianChart = /* @__PURE__ */ (0, import_react.forwardRef)(
  function CartesianChart(props, ref) {
    var _categoricalChartProp
    var rootChartProps = resolveDefaultProps(
    ...
    return /* @__PURE__ */ import_react.createElement(
      ...
      /* @__PURE__ */ import_react.createElement(ChartDataContextProvider, {
        chartData: categoricalChartProps.data
      }),
      /* @__PURE__ */ import_react.createElement(ReportMainChartProps, {
