...
const Footer = () => (
  <footer>
    <div className="grid space-x-32 border-y p-8 md:grid-cols-3">
      <div>
        <Link to="/" className="flex items-center gap-2 text-lg font-semibold tracking-tighter">
          <RupertSvg className="size-8" />
          Rupert
        </Link>
        <p className="max-w-md text-sm">
          A platform for sharing projects, finding jobs, publishing posts, and connecting with the
          community.
        </p>
      </div>
    ...
    <p className="py-2 text-center text-xs">
      © {new Date().getFullYear()} Rupert. All rights reserved.
    </p>
  </footer>
)
