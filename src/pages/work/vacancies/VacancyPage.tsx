...
const VacancyPage = () => {
  ...
  const isOwner = isAuthenticated && vacancy.permission.isOwner
  ...
  return (
    <div className="col-span-3 space-y-4">
      ...
      {isAuthenticated && !isOwner && <ApplicationForm vacancy={vacancy} />}
      <VacancySkills vacancy={vacancy} isOwner={isOwner} />
      {isOwner && <VacancyApplications vacancy={vacancy} />}
      {isOwner && <VacancyForm vacancy={vacancy} open={editOpen} onOpenChange={setEditOpen} />}
    </div>
  )
}
